...
<html lang="en" dir="{{isRtl()?'rtl':''}}" class="{{isRtl()?'rtl':''}}">
  <head>
    ...
    <title>{{ __('defaultTheme.401_unauthorized') }}</title>
    <style>
    	body{
  ...
  <div class="md:flex min-h-screen">
            <div class="w-full md:w-1/2   flex items-center justify-center">
                <div class="max-w-sm m-8">
                    <div class="text-black text-5xl md:text-15xl font-black">
                    	<img src="{{url(asset_path('svg/403.svg'))}}" alt="" class="img img-fluid">  </div>

                    <div class="w-16 h-1 bg-purple-light my-3 md:my-6"></div>

                    <p class="text-grey-darker text-2xl md:text-3xl font-light mb-8 leading-normal text-white">
                         {{ __('defaultTheme.sorry_you_are_not_authorized_to_access_this_page') }}                  </p>
        ...
        <script src="{{ asset(asset_path('backend/vendors/js/jquery-3.5.1.min.js')) }}"></script>
