<div class="modal fade" id="InstamojoModal" tabindex="-1" role="dialog" aria-labelledby="InstamojoModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{ __('wallet.instamojo_payment') }}</h5>
            ...
            <div class="modal-body">
                <section class="send_query bg-white contact_form">
                    <form id="instamojo_form" action="{{route('my-wallet.store')}}" class="p-0" method="POST">
                        @csrf
                        ...
                        <div class="row mb-20">
                            <div class="col-xl-6 col-md-6">
                                ...
                                <input type="text" class="primary_input4 form-control mb_20" placeholder="{{ __('common.mobile') }}" name="mobile" value="{{@old('mobile')}}">
                                <span class="text-danger"></span>
                            </div>
                            <div class="col-xl-6 col-md-6">
                        ...
                        <div class="send_query_btn d-flex justify-content-between mt-4">
                            ...
                            <button class="btn_1" type="submit" id="intamojo_submit_btn" disabled>{{ __('wallet.continue_to_recharge') }}</button>
                        </div>
                    </form>
                </section>
            </div>
