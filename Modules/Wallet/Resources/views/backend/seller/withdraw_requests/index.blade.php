                ...
                <a href="#" class="d-block">
                    <div class="white-box single-summery">
                        <div class="d-flex justify-content-between">
                            ...
                            <h1 class="gradient-color2">{{ single_price(auth()->user()->SellerCurrentWalletAmounts) }}</h1>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <a href="#" class="d-block">
                    <div class="white-box single-summery">
                        <div class="d-flex justify-content-between">
                            ...
                            <h1 class="gradient-color2">{{ single_price(auth()->user()->SellerWithdrawAmounts) }}</h1>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <a href="#" class="d-block">
                    <div class="white-box single-summery">
                        <div class="d-flex justify-content-between">
                            ...
                            <h1 class="gradient-color2">{{ single_price(auth()->user()->SellerPendingWithdrawAmounts) }}</h1>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <a href="#" class="d-block">
                    <div class="white-box single-summery">
                        <div class="d-flex justify-content-between">
                            ...
                            <h1 class="gradient-color2">{{ single_price(auth()->user()->SellerRefundBackAmounts) }}</h1>
                        </div>
                    </div>
                </a>
            </div>
