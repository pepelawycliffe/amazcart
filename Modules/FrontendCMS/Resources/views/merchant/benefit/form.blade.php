        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="primary_input mb-25">
                <label class="primary_input_label"
                    for="">{{ __('common.title') }} <span class="text-danger">*</span></label></label>
            ...
            <div class="primary_input mb-35">
                <label class="primary_input_label" for="">{{__('common.image')}}
                    <span class="text-danger">*</span><small
                        class="ml-1">(80x60)px</small> </label>
                <div class="primary_file_uploader">
                    <input class="primary-input" type="text" id="benifit_{{$form_id}}"
                    ...
                    <img id="BenefitImgshow_{{$form_id}}" class="benefit_img_show"
