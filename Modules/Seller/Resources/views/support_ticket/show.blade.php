                            ...
                            <div class="tickets_view_lists mb-50">
                                <div class="single_tks_view_list ">
                                    <div class="tkt_owner d-flex align-items-center mb-20">
                                        <div class="thumb">
                                            <img src="@if($SupportTicket->user->role->type == 'customer') {{asset(asset_path(@$SupportTicket->user->avatar?@$SupportTicket->user->avatar:'frontend/default/img/avatar.jpg'))}} @elseif($SupportTicket->user->role->type == 'seller') {{asset(asset_path(@$SupportTicket->user->photo?@$SupportTicket->user->photo:'frontend/default/img/avatar.jpg'))}} @else {{asset(asset_path('backend/img/chat/sender.png'))}}  @endif"
                                                alt="">
                                        </div>
                                ...
                                <div class="comments_checklisted">
                                    ...
                                    <div class="single_list d-flex pb-10 pt-15">
                                        <div class="thumb">
                                            <a href="#"><img
                                                    src="@if($message->user->role->type == 'customer') {{asset(asset_path(@$message->user->avatar?@$SupportTicket->user->avatar:'frontend/default/img/avatar.jpg'))}} @elseif($message->user->role->type == 'seller') {{asset(asset_path(@$message->user->photo?@$SupportTicket->user->photo:'frontend/default/img/avatar.jpg'))}} @else {{asset(asset_path('backend/img/chat/sender.png'))}}  @endif"
                                                    alt=""></a>
                                        </div>
                                        <div class="list_name">
