                        ...
                        <div class="col-lg-12 attribute_div">
                            <div class="primary_input mb-25">
                                ...
                                <select name="choice_attributes[]" id="choice_attributes" class="primary_select mb-15"
                                    ...
                                    <option value="{{ $attribute->id }}" @if ($product->
                                        variations->where('attribute_id', $attribute->id)->first()) selected
                        ...
                        <div class="col-lg-8">
                            <div class="primary_input mb-15">
                                ...
                                <input class="primary_input_field" name="tax" placeholder="{{ __('product.tax') }}"
                                    type="number" min="0" step="{{step_decimal()}}" value="{{ $product->tax }}">
                        ...
                        <div class="col-lg-12 digital_file_upload_div_edit">
                            <div class="primary_input mb-25">
                                <label class="primary_input_label" for="">{{ __('product.program_file_upload') }}
                                    ...
                                    <small> <a href="{{ asset(asset_path(@$product->skus->first()->digital_file->file_source)) }}"
