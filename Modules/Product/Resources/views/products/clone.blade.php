                                ...
                                <div class="white_box pt-0 box_shadow_white mb-20 p-15">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="primary_input mb-15">
                                                ...
                                                <input class="primary_input_field" name="product_name" id="product_name" placeholder="{{__("common.name")}}" type="text" value="{{ $product->product_name }}" required="1">
                                        ...
                                        <div class="col-lg-12 attribute_div">
                                            <div class="primary_input mb-25">
                                                ...
                                                <select name="choice_attributes[]" id="choice_attributes" class="primary_select mb-15 choice_attribute" multiple disabled>
                                                    <option value="">{{__('product.select_attribute')}}</option>
                                                    @foreach($attributes as $key => $attribute)
                                                    <option value="{{$attribute->id}}" @if ($product->variations->where('attribute_id', $attribute->id)->first()) selected @endif>{{$attribute->name}}</option>
                                                    @endforeach
                                            </select>
                                    ...
                                    <div class="customer_choice_options" id="customer_choice_options">
                                        @foreach ($product->variations->unique("attribute_id") as $key => $choice_option)
                                            ...
                                            <div class="col-lg-8">
                                                <div class="primary_input mb-25">
                                                    <select name="choice_options_{{ $choice_option->attribute_id }}[]" id="choice_options" class="primary_select mb-15" multiple>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="primary_input mb-25">
                                                ...
                                                <label class="primary_input_label" for="">@lang('blog.tags')<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-lg-8">
                                            <div class="primary_input mb-15">
                                                ...
                                                <input class="primary_input_field" name="tax" id="tax" placeholder="{{__("product.tax")}}" type="number" min="0" step="{{step_decimal()}}" value="{{ $product->tax }}">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="primary_input mb-25">
                                                ...
                                                <select class="primary_select mb-25" name="tax_type" id="tax_type">
                                                    <option value="1" @if ($product->tax_type == 1) selected @endif>{{ __('common.amount') }}</option>
                                                    <option value="0" @if ($product->tax_type == 0) selected @endif>{{ __('common.percentage') }}</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-lg-8">
                                        ...
                                        @if ($product->is_physical == 0)
                                            <div class="col-lg-12 digital_file_upload_div_edit">
                                                <div class="primary_input mb-25">
                                                    <label class="primary_input_label" for="">{{ __('product.program_file_upload') }} <small> <a href="{{ asset(asset_path(@$product->skus->first()->digital_file->file_source)) }}" download>{{__('product.download_link')}}</a> </small> </label>
