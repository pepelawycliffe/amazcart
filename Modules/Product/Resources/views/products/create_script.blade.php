@push('scripts')
    ...
    (function($) {
        ...
        $(".lodeMoreRelatedSale").on('click',function() {
            event.preventDefault();
            Rpage++;
            var new_url = '/product/get-related-product-for-admin?page=';
        ...
        $(".lodeMoreUpSale").on('click',function() {
            event.preventDefault();
            Upage++;
            var new_url = '/product/get-upsale-product-for-admin?page=';
        ...
        $(".lodeMoreCrossSale").on('click',function() {
            event.preventDefault();
            Cpage++;
            var new_url = '/product/get-cross-sale-product-for-admin?page=';
