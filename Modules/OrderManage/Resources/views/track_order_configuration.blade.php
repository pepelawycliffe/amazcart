                ...
                <div class="white_box_30px">
                    <form action="{{ route('track_order_configuration.update') }}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12">
                                <div class="primary_input">
                                    <label class="primary_input_label" for="">{{ __('order.track_order') }} {{ __('common.by') }} {{ __('common.phone') }}
                                        &nbsp; &nbsp;</label>
                                    <ul id="theme_nav" class="permission_list sms_list ">
                                        <li>
                                            
                                            <label data-id="bg_option" class="primary_checkbox d-flex mr-12">
                                                <input name="track_order_by_phone" id="status_active" value="1"
                                                    {{$trackOrderConfiguration->track_order_by_phone == 1?'checked':''}}
                                                    class="active" type="radio">
                                                <span class="checkmark"></span>
                                            </label>
                                            <p>{{ __('common.active') }}</p>
                                        ...
                                        <li>
                                            <label data-id="color_option" class="primary_checkbox d-flex mr-12">
                                                <input name="track_order_by_phone" value="0" id="status_inactive"
                                                    {{$trackOrderConfiguration->track_order_by_phone == 0?'checked':''}}
                                                    class="de_active" type="radio">
                                                <span class="checkmark"></span>
                                            </label>
                                            <p>{{ __('common.inactive') }}</p>
