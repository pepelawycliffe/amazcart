                            ...
                            <div class="col-lg-4">
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-lg-12">
                                        ...
                                        <img id="ThumbnailImg" src="{{ asset(asset_path($card->thumbnail_image??'backend/img/default.png')) }}" alt="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div id="gallery_img_prev">
                                            ...
                                            <div class="galary_img_div">
                                                <img class="galaryImg" src="{{asset(asset_path($image->image_name))}}" alt="">
                                            </div>
                                            @endforeach
                                        </div>
